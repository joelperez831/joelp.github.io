...
#### It's not suprising that the most mentioned characters of Rick and Morty are Rick and Morty. However, we can see Morty was the real star of the first season. He was mentioned about twice as much as Rick and after the first season, he dropped all the way down. Justin Roiland, the voice of Rick and Morty, said in a podast that he felt Rick saying "Morty" was a verbal crutch and wanted to try to get rid of it. As we can see by the graph, he really did follow through.  

#### TF-IDF is the term frequency-inverse document frequency. It is a large part in text mining. Words that appear often get a lower tf-idf and uncommon ones a higher tf-idf. So, let's plot the top 20 words per season and exclude main character names, very common everyday words, aka stop words, and some random words from the subtitle file.    
...
```  
  ...
  We can see from that the top positions for each season are: meeseeks, unity and pickle, which, if you watch Rick and Morty, is not so suprising.  
