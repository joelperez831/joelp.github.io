...
###From the tibble above, we can see the words following the word "god" and the words after the word "god". It looks like "my god"", "oh god" and "god damn" are the most commonly used phrases with the word god. If we assume the context of these phrases to be stricktly negative, which as an avid fan, I can say that they are definitely used more in a negative context and if we treat them as such, let's see how that changes the overall sentiment of the show.  
```{r}
randmSent <- tidydf %>% inner_join(nrcSent)
